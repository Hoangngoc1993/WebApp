<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <div class="footer">
                ...
                <div class="col-md-3 customer__connect">
                    ...
                    <div class="row">
                        <div class="col-md-2 social-network">
                            <a href="">
                                <img src="./public/assets/img/connect/facebook-logo2.png" style="width: 98%;" alt="">
                            </a>
                        </div>
                        <div class="col-md-2">
                            <a href="">
                                <img src="./public/assets/img/connect/google-logo3.png" style="width: 95%;" alt="">
                            </a>
                        </div>
                        <div class="col-md-2">
                            <a href="">
                                <img src="./public/assets/img/connect/youtube-logo2.png" style="width: 95%;" alt="">
                            </a>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="col-md-2"></div>
            ...
            <div class="row main-footer">
                <div class="col-md-1"></div>
                <div class="col-md-3">
                    <img src="./public/assets/img/connect/logo-fiona.png" class="logo-fiona" alt="">
