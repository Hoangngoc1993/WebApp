                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <!--                            <a href="CreateUserServlet" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        ...
                        <div class="row">
                            ...
                            <form action="EditProductServlet" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control" value="${product.name}" aria-describedby="emailHelp" placeholder="Enter name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="image" class="form-control"  value="${product.image}" placeholder="Image">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="oldPrice" class="form-control"  value="${product.oldPrice}" placeholder="Old Price">
                                </div>
                                <div class="form-group">
