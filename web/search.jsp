    ...
    <body>
        ...
        <div class="row link_detail">
            ...
            <div class="col-md-11">
                ...
                <a href="" style="color: rgb(255, 72, 0);">"${key}"</a>
            </div>
        </div>
        <!-- search container -->
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-md-9">
                    <div class="row" style="margin-bottom: 10px;">
                        <c:set var="numberOfSearchItem" value="${0}"/>
                        <c:forEach items="${productList}" var="product">
                            ...
                            <c:set var="numberOfSearchItem" value="${numberOfSearchItem + 1}"/>
                        </c:forEach>
                    </div>
                    <h6>Từ khóa "${key}" có ${numberOfSearchItem} kết quả tìm kiếm.</h6>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
